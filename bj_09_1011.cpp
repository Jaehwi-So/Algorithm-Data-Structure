...
/*
1 (1 : 1) / 11 (2 : 2)
111 121 (3~4 : 3) / 1211 1221 (5~6 : 4)
12211 12221 12321 (7~9 : 5) /123211 123221 123321 (10~12 : 6)
1233211 1233221 1233321 1234321 (13~16 :7) / 12343211 12343221 12343321 12344321 (17~20 :8)
*/
#include<stdio.h>
int main() {
	int t, x, y;
	...
	for (int i = 0; i < t; i++) {
		...
		while (k < distance) {
			temp = result;
			for (int l = 0; l < range && k < distance; l++) {
				result = temp + 1;
				k++;
			}
			for (int l = 0; l < range && k < distance; l++) {
